...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light bg-transparent" id="gtco-main-nav">
        ...
        <li> Αποθηκευμένες Αιτήσεις</li>
    </ul>
    <div class="forms" id="forms">
        <h3 style="text-align:center"><strong>Αποθηκευμένες αιτήσεις</strong></h3><br /><br /><br />
            <div class="table">
        <?php
        ...
        $sql = "SELECT * FROM form WHERE userid = '$id' AND final = 1";
    ...
    echo"<table>";
    echo"<tr><th>Αριθμός αίτησης</th><th>Ημερομηνία επεξεργασίας</th><th>";
    while($row = $result->fetch_assoc()) {
    echo "<tr><td> <input type='Submit' name='formid' value='" . $row["id"]. "'/> </td><td>" . $row["date"] . "</td><td>";
    }
    echo "</table>";
    echo"</form>";
    } else { echo "0 results"; }
