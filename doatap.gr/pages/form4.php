...
<body>
    ...
    <div class="box2">
        ...
        <div class="container" , id="=login">
            <h1 style="text-align:center"><strong>Οριστική υποβολή της αίτησης</strong></h1>
            <br /><br /><br />
                        <div class="form-center">
                            ...
                            echo"<form method='post' action='../php/DBform4.php'>
                                ";
                                ...
                                ?>
                                    ...
                                    <div class="container button">
                                        ...
                                        <input style="width:250px" type="submit" value="Οριστική υποβολή"><br /><br /><br />
                                    </div>
